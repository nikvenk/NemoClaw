...
# 4b: curl api.github.com (bug reporter's exact target)
# With protocol: rest + access: full, traffic goes through the L7 proxy's
# normal TLS-termination path — no special proxy env needed.
